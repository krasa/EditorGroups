			...
			protected void addCompletions(@NotNull final CompletionParameters parameters,
				...
				if (contextFile != null) {
					...
					for (String fileName : fileNames) {
						if (filenameMatchesPrefixOrType(fileName, prefix, FileType.EMPTY_ARRAY, parameters.getInvocationCount())) {
...
//			String prefix = text.substring(from+keywordEndIndex, Math.min(to, text.length());
			...
			document.replaceString(from + keywordEndIndex, to, relativePath);
