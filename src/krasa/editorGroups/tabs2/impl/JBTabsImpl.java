...
import krasa.editorGroups.tabs2.impl.singleRow.SingleRowPassInfo;
import krasa.editorGroups.tabs2.impl.table.TableLayout;
...
public class JBTabsImpl extends JComponent
	...
	private krasa.editorGroups.tabs2.impl.TabLayout myLayout;
...
//	private IdeGlassPane myGlassPane;
	...
	private krasa.editorGroups.tabs2.impl.DragHelper myDragHelper;
	...
	private krasa.editorGroups.tabs2.impl.TabLabel tabLabelAtMouse;
...
//		};
	...
	public void uiSettingsChanged(UISettings uiSettings) {
		for (Map.Entry<TabInfo, krasa.editorGroups.tabs2.impl.TabLabel> entry : myInfo2Label.entrySet()) {
	...
	public void setHovered(krasa.editorGroups.tabs2.impl.TabLabel label) {
		krasa.editorGroups.tabs2.impl.TabLabel old = tabLabelAtMouse;
	...
	public void unHover(krasa.editorGroups.tabs2.impl.TabLabel label) {
	...
	protected boolean isHoveredTab(krasa.editorGroups.tabs2.impl.TabLabel label) {
	...
	private void repaintAttractions() {
		...
		for (TabInfo each : myVisibleInfos) {
			krasa.editorGroups.tabs2.impl.TabLabel eachLabel = myInfo2Label.get(each);
...
//		}
	...
	class TabActionsAutoHideListener extends MouseMotionAdapter implements Weighted {
		...
		private krasa.editorGroups.tabs2.impl.TabLabel myCurrentOverLabel;
		...
		void processMouseOver() {
			...
			if (myLastOverPoint.x >= 0 && myLastOverPoint.x < getWidth() && myLastOverPoint.y > 0 && myLastOverPoint.y < getHeight()) {
				final krasa.editorGroups.tabs2.impl.TabLabel label = myInfo2Label.get(_findInfo(myLastOverPoint, true));
				if (label != null) {
	...
	private TabInfo addTab(TabInfo info, int index, boolean isDropTarget, boolean fireEvents) {
		...
		final krasa.editorGroups.tabs2.impl.TabLabel label = createTabLabel(info);
	...
	protected krasa.editorGroups.tabs2.impl.TabLabel createTabLabel(TabInfo info) {
		return new krasa.editorGroups.tabs2.impl.TabLabel(this, info);
	}
	...
	@Override
	public krasa.editorGroups.tabs2.impl.TabLabel getTabLabel(TabInfo info) {
	...
	private ActionCallback executeSelectionChange(TabInfo info, boolean requestFocus) {
		...
		krasa.editorGroups.tabs2.impl.TabLabel label = myInfo2Label.get(info);
		if (label != null) {
	...
	private void updateEnabling() {
		...
		for (TabInfo each : all) {
			final krasa.editorGroups.tabs2.impl.TabLabel eachLabel = myInfo2Label.get(each);
...
//		}
	...
	private void updateText(final TabInfo tabInfo) {
		final krasa.editorGroups.tabs2.impl.TabLabel label = myInfo2Label.get(tabInfo);
	...
	public void doLayout() {
		try {
			...
			final Collection<krasa.editorGroups.tabs2.impl.TabLabel> labels = myInfo2Label.values();
			for (krasa.editorGroups.tabs2.impl.TabLabel each : labels) {
			...
			if (isStealthModeEffective() && !isHideTabs()) {
				final krasa.editorGroups.tabs2.impl.TabLabel label = getSelectedLabel();
...
//			myTabActionsAutoHideListener.processMouseOver();
	...
	void moveDraggedTabLabel() {
		if (myDragHelper != null && myDragHelper.myDragRec != null) {
			final krasa.editorGroups.tabs2.impl.TabLabel selectedLabel = myInfo2Label.get(getSelectedInfo());
	...
	protected krasa.editorGroups.tabs2.impl.TabLabel getSelectedLabel() {
	...
	private Max computeMaxSize() {
		...
		for (TabInfo eachInfo : myVisibleInfos) {
			final krasa.editorGroups.tabs2.impl.TabLabel label = myInfo2Label.get(eachInfo);
	...
	private Dimension computeHeaderPreferredSize(int tabsCount) {
		...
		while (infos.hasNext()) {
			...
			final krasa.editorGroups.tabs2.impl.TabLabel eachLabel = myInfo2Label.get(eachInfo);
	...
	private void processRemove(final TabInfo info, boolean forcedNow) {
		...
		krasa.editorGroups.tabs2.impl.TabLabel tabLabel = myInfo2Label.get(info);
		if (tabLabel != null) {
	...
	private TabInfo _findInfo(final Point point, boolean labelsOnly) {
		...
		while (component != this || component != null) {
			if (component instanceof krasa.editorGroups.tabs2.impl.TabLabel) {
				return ((krasa.editorGroups.tabs2.impl.TabLabel) component).getInfo();
			}
			if (!labelsOnly) {
	...
	protected void addImpl(final Component comp, final Object constraints, final int index) {
		...
		if (comp instanceof krasa.editorGroups.tabs2.impl.TabLabel) {
			((krasa.editorGroups.tabs2.impl.TabLabel) comp).apply(myUiDecorator != null ? myUiDecorator.getDecoration() : ourDefaultDecorator.getDecoration());
		}
	...
	private void applyDecoration() {
		if (myUiDecorator != null) {
			...
			for (krasa.editorGroups.tabs2.impl.TabLabel each : myInfo2Label.values()) {
	...
	public Image startDropOver(TabInfo tabInfo, RelativePoint point) {
		...
		krasa.editorGroups.tabs2.impl.TabLabel label = myInfo2Label.get(myDropInfo);
	...
	protected class AccessibleJBTabsImpl extends AccessibleJComponent implements AccessibleSelection {
		...
		public String getAccessibleName() {
			...
			if (name == null) {
				...
				// as our own name.
				krasa.editorGroups.tabs2.impl.TabLabel selectedLabel = getSelectedLabel();
				if (selectedLabel != null) {
		...
		public Accessible getAccessibleChild(int i) {
			...
			if (accessibleChild instanceof krasa.editorGroups.tabs2.impl.TabLabel) {
				krasa.editorGroups.tabs2.impl.TabLabel label = (krasa.editorGroups.tabs2.impl.TabLabel) accessibleChild;
	...
	private class AccessibleTabPage extends AccessibleContext
		...
		private krasa.editorGroups.tabs2.impl.TabLabel getTabLabel() {
		...
		public String getAccessibleName() {
			...
			if (name == null) {
				krasa.editorGroups.tabs2.impl.TabLabel label = getTabLabel();
