...
public interface JBTabs {
	...
	@NotNull
	krasa.editorGroups.tabs.JBTabs addTabMouseListener(@NotNull MouseListener listener);

	krasa.editorGroups.tabs.JBTabs addListener(@NotNull TabsListener listener);

	krasa.editorGroups.tabs.JBTabs setSelectionChangeHandler(SelectionChangeHandler handler);
	...
	krasa.editorGroups.tabs.JBTabs setNavigationActionBinding(String prevActiobId, String nextActionId);

	krasa.editorGroups.tabs.JBTabs setNavigationActionsEnabled(boolean enabled);
