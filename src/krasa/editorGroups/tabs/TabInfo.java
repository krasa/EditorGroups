...
public class TabInfo implements Queryable, PlaceProvider<String> {
	...
	public krasa.editorGroups.tabs.TabInfo setText(String text) {
	...
	public krasa.editorGroups.tabs.TabInfo clearText(final boolean invalidate) {
	...
	public krasa.editorGroups.tabs.TabInfo append(String fragment, SimpleTextAttributes attributes) {
		final String old = myText.toString();
	...
	public krasa.editorGroups.tabs.TabInfo setIcon(Icon icon) {
		Icon old = myIcon;
	...
	public krasa.editorGroups.tabs.TabInfo setSideComponent(JComponent comp) {
	...
	public krasa.editorGroups.tabs.TabInfo setActions(ActionGroup group, String place) {
	...
	public krasa.editorGroups.tabs.TabInfo setActionsContextComponent(JComponent c) {
	...
	public krasa.editorGroups.tabs.TabInfo setObject(final Object object) {
		myObject = object;
		return this;
	}
	...
	public krasa.editorGroups.tabs.TabInfo setTabLabelActions(final ActionGroup tabActions, String place) {
	...
	public krasa.editorGroups.tabs.TabInfo setAlertIcon(final AlertIcon alertIcon) {
	...
	public krasa.editorGroups.tabs.TabInfo setDefaultStyle(@SimpleTextAttributes.StyleAttributeConstant int style) {
	...
	public krasa.editorGroups.tabs.TabInfo setDefaultForeground(final Color fg) {
	...
	public krasa.editorGroups.tabs.TabInfo setDefaultWaveColor(final Color waveColor) {
	...
	public krasa.editorGroups.tabs.TabInfo setTooltipText(final String text) {
	...
	public krasa.editorGroups.tabs.TabInfo setTabColor(Color color) {
	...
	public krasa.editorGroups.tabs.TabInfo setTestableUi(Queryable queryable) {
	...
	public krasa.editorGroups.tabs.TabInfo setDragOutDelegate(DragOutDelegate delegate) {
	...
	public void setPreviousSelection(@Nullable krasa.editorGroups.tabs.TabInfo previousSelection) {
		myPreviousSelection = new WeakReference<>(previousSelection);
	}

	@Nullable
	public krasa.editorGroups.tabs.TabInfo getPreviousSelection() {
		return myPreviousSelection.get();
	}

	public interface DragOutDelegate {

		void dragOutStarted(MouseEvent mouseEvent, krasa.editorGroups.tabs.TabInfo info);

		void processDragOut(MouseEvent event, krasa.editorGroups.tabs.TabInfo source);

		void dragOutFinished(MouseEvent event, krasa.editorGroups.tabs.TabInfo source);

		void dragOutCancelled(krasa.editorGroups.tabs.TabInfo source);
	}
