 ...
 */
package krasa.editorGroups.tabs.impl.table;

import krasa.editorGroups.tabs.TabInfo;
import krasa.editorGroups.tabs.impl.JBTabsImpl;
import krasa.editorGroups.tabs.impl.LayoutPassInfo;
...
public class TablePassInfo extends LayoutPassInfo {
	final List<krasa.editorGroups.tabs.impl.table.TableRow> table = new ArrayList<>();
	public Rectangle toFitRec;
	final Map<TabInfo, krasa.editorGroups.tabs.impl.table.TableRow> myInfo2Row = new HashMap<>();
	...
	public TabInfo getPreviousFor(final TabInfo info) {
		final krasa.editorGroups.tabs.impl.table.TableRow row = myInfo2Row.get(info);
	...
	public boolean isInSelectionRow(final TabInfo tabInfo) {
		final krasa.editorGroups.tabs.impl.table.TableRow row = myInfo2Row.get(tabInfo);
