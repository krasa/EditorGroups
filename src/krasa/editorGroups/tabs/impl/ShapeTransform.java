...
public abstract class ShapeTransform {
	...
	public abstract krasa.editorGroups.tabs.impl.ShapeTransform createTransform(Rectangle innerRec);

	public abstract krasa.editorGroups.tabs.impl.ShapeTransform copy();
	...
	public final krasa.editorGroups.tabs.impl.ShapeTransform moveTo(int x, int y) {
		if (mySwap) {
	...
	public final krasa.editorGroups.tabs.impl.ShapeTransform quadTo(int x1, int y1, int x2, int y2) {
		if (mySwap) {
			//noinspection SuspiciousNameCombination
	...
	public final krasa.editorGroups.tabs.impl.ShapeTransform lineTo(int x, int y) {
		if (mySwap) {
			//noinspection SuspiciousNameCombination
			myPath.lineTo(y, x);
		} else {
	...
	public final krasa.editorGroups.tabs.impl.ShapeTransform reset() {
		return reset(null);
	}

	protected final krasa.editorGroups.tabs.impl.ShapeTransform reset(Rectangle shapeRec) {
	...
	public final krasa.editorGroups.tabs.impl.ShapeTransform closePath() {
		myPath.closePath();
		return this;
	}

	public final krasa.editorGroups.tabs.impl.ShapeTransform doRect(int x, int y, int width, int height) {
		if (width <= 0 || height <= 0) return this;
		return moveTo(x, y).lineTo(x + deltaX(width), y).lineTo(x + deltaX(width), y + deltaY(height)).lineTo(x, y + deltaY(height)).closePath();
	}

	public static class Top extends krasa.editorGroups.tabs.impl.ShapeTransform {
		...
		@Override
		public krasa.editorGroups.tabs.impl.ShapeTransform createTransform(Rectangle innerRec) {
		...
		public krasa.editorGroups.tabs.impl.ShapeTransform copy() {
			return new Top((Rectangle) getShapeRect().clone(), (GeneralPath) myPath.clone());
		}
	}

	public static class Left extends krasa.editorGroups.tabs.impl.ShapeTransform {
		public Left() {
			this(null);
		}
	...
	public static class Bottom extends krasa.editorGroups.tabs.impl.ShapeTransform {
	...
	public static class Right extends krasa.editorGroups.tabs.impl.ShapeTransform {
