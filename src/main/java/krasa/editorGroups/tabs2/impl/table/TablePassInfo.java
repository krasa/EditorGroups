...
public class TablePassInfo extends LayoutPassInfo {
	final List<krasa.editorGroups.tabs2.impl.table.TableRow> table = new ArrayList<>();
	public Rectangle toFitRec;
	final Map<TabInfo, krasa.editorGroups.tabs2.impl.table.TableRow> myInfo2Row = new HashMap<>();
	...
	public TabInfo getPreviousFor(final TabInfo info) {
		final krasa.editorGroups.tabs2.impl.table.TableRow row = myInfo2Row.get(info);
	...
	public boolean isInSelectionRow(final TabInfo tabInfo) {
		final krasa.editorGroups.tabs2.impl.table.TableRow row = myInfo2Row.get(tabInfo);
