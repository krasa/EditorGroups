...
public abstract class ShapeTransform {
	...
	public static class Top extends ShapeTransform {
		...
		public ShapeTransform createTransform(Rectangle innerRec) {
			return new krasa.editorGroups.tabs2.impl.ShapeTransform.Top(innerRec);
		}
		...
		public ShapeTransform copy() {
			return new krasa.editorGroups.tabs2.impl.ShapeTransform.Top((Rectangle) getShapeRect().clone(), (GeneralPath) myPath.clone());
		}
	}
	...
	public static class Left extends ShapeTransform {
		...
		@Override
		public ShapeTransform createTransform(Rectangle innerRec) {
			return new krasa.editorGroups.tabs2.impl.ShapeTransform.Left(innerRec);
		}
		...
		@Override
		public ShapeTransform copy() {
			return new krasa.editorGroups.tabs2.impl.ShapeTransform.Left((Rectangle) getShapeRect().clone(), (GeneralPath) myPath.clone());
		}
	}
	...
	public static class Bottom extends ShapeTransform {
		...
		@Override
		public ShapeTransform copy() {
			return new krasa.editorGroups.tabs2.impl.ShapeTransform.Bottom((Rectangle) getShapeRect().clone(), (GeneralPath) myPath.clone());
		}

		@Override
		public ShapeTransform createTransform(Rectangle innerRec) {
			return new krasa.editorGroups.tabs2.impl.ShapeTransform.Bottom(innerRec);
		}
	...
	public static class Right extends ShapeTransform {
		...
		@Override
		public ShapeTransform copy() {
			return new krasa.editorGroups.tabs2.impl.ShapeTransform.Right((Rectangle) getShapeRect().clone(), (GeneralPath) myPath.clone());
		}
		...
		@Override
		public ShapeTransform createTransform(Rectangle innerRec) {
			return new krasa.editorGroups.tabs2.impl.ShapeTransform.Right(innerRec);
		}
