...
public abstract class JBEditorTabsPainter {
	...
	protected final krasa.editorGroups.tabs2.impl.JBEditorTabs myTabs;
	...
	public abstract void fillSelectionAndBorder(Graphics2D g, krasa.editorGroups.tabs2.impl.JBTabsImpl.ShapeInfo selectedShape, Color tabColor, int x, int y, int height);
